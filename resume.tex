...
& \multicolumn{2}{c}{\parbox{\middleboxsize}{ \begin{itemize} 
\item Developed an open-source method for instantly producing optimized variants of any avatar by utilizing Blender's own internal rendering engine and a number of data manipulations, bringing production-quality models to the Oculus Quest/Android in a single step (Github: cats-blender-plugin, 'CATS Bake')
