...
\item Completely rewrote several server softwares from the ground up to be streamlined, greatly reducing latency and significantly reducing memory and CPU footprint
...
\item Experience in \textbf{Android development}, and creating \textbf{cross-platform libraries} with \textbf{SWIG}
\item Experience in libraries including \textbf{SDL/2, POSIX, OpenAL Soft}
\item In-depth experience with \textbf{Git} and \textbf{SVN} source tracking 
\end{itemize} } } \\
...
& \multicolumn{2}{c}{\parbox{\middleboxsize}{ \begin{itemize} 
\item Experienced in programming \textbf{high-level code} for \textbf{embedded systems}
